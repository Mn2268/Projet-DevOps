...
$adminStmt = $pdo->prepare("SELECT id, user_id, username FROM users WHERE role = 'admin' ORDER BY username");
$adminStmt->execute();
            ...
            <form class="modal-body" id="addElectionForm">
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <select id="election_admin_user_id" name="admin_user_id" required class="custom-select">
                            <option value=""><?php echo t('select_admin', 'Sélectionner un administrateur'); ?></option>
                            <?php foreach($adminUsers as $admin): ?>
                                <option value="<?= $admin['id']; ?>">
                                    <?= htmlspecialchars($admin['username']); ?> (<?= $admin['user_id']; ?>)
                                </option>
                            <?php endforeach; ?>
                        </select>
                    </div>
