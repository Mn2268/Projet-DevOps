document.addEventListener('DOMContentLoaded', async function () {
  ...
  async function fetchElections() {
    try {
      const response = await fetch('../core/api.php?action=getAllElections');
  ...
  async function fetchCandidatesByElection(electionId) {
    try {
      const response = await fetch(`../core/api.php?action=getCandidatesByElection&id_election=${electionId}`);
